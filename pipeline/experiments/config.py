"""Pipeline configuration — constants, API keys, scoring weights."""
...
DB_PATH = PIPELINE_DIR / "glytec_v1.db"
API_LOG_PATH = PIPELINE_DIR / "api_call_log.md"

# ---------------------------------------------------------------------------
# Scoring weights (from v1-tool-stack.md)
# ---------------------------------------------------------------------------
SCORING_WEIGHTS = {
    "bed_count": 0.20,
    "margin": 0.15,
...
# ---------------------------------------------------------------------------
# Kill-switch thresholds (from v1-tool-stack.md)
# ---------------------------------------------------------------------------
